# 1 "src/app/system_config/pic32_mx/system_init.c"
# 1 "C:\\Users\\Justin\\MPLABXProjects\\CNC\\Firmware\\CNC.X//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/app/system_config/pic32_mx/system_init.c"
# 44 "src/app/system_config/pic32_mx/system_init.c"
# 1 "src/app/app.h" 1
# 35 "src/app/app.h"
...
# 44 "c:\\microchip\\xc32\\v1.31\\bin\\../lib/gcc/pic32mx/4.5.2/../../../../pic32mx/include/peripheral/adc10.h" 3
...
# 13 "c:\\microchip\\xc32\\v1.31\\bin\\../lib/gcc/pic32mx/4.5.2/../../../../pic32mx/include/string.h" 3
...
# 45 "c:\\microchip\\xc32\\v1.31\\bin\\../lib/gcc/pic32mx/4.5.2/../../../../pic32mx/include/peripheral/adc10.h" 2 3
...
_Bool tmrIntTriggered;

extern APP_DATA appObject;
# 45 "src/app/system_config/pic32_mx/system_init.c" 2
# 1 "src/app/system_config/pic32_mx/system_definitions.h" 1
# 99 "src/app/system_config/pic32_mx/system_definitions.h"
typedef struct
{

} SYSTEM_OBJECTS;
# 111 "src/app/system_config/pic32_mx/system_definitions.h"
extern SYSTEM_OBJECTS systemObjects;
# 46 "src/app/system_config/pic32_mx/system_init.c" 2
# 64 "src/app/system_config/pic32_mx/system_init.c"
...
# 170 "src/app/system_config/pic32_mx/system_init.c"
void SYS_Initialize ( void* data )
{
   ...
   SYSTEMConfigPerformance(80000000);
    ...
    (LATACLR = (unsigned int)((1 << 7) | (1 << 6) | (1 << 5) | (1 << 5) | (1 << 4) | (1 << 3) | (1 << 2) | (1 << 1) | (1 << 0)))
                                                                                    ;

    (TRISACLR = (unsigned int)((1 << 7) | (1 << 6) | (1 << 5) | (1 << 5) | (1 << 4) | (1 << 3) | (1 << 2) | (1 << 1) | (1 << 0)))
                                                                                    ;
